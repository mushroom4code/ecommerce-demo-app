<div class="modal fade details-7" id="details-7" tableindex="-1" role="dialog" aria-labelled="details-7" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center">Джинсы ICE&BERRY</h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="center-block">
                                <img src="images/ICE&BERRY.jpg" class="details img-responsive">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <h4>Подробнее</h4>
